...
# Instead of making a 3D plot, which is difficult to interpret, we will look
# at vertical slices of the 3D plot by plotting each variable seperately as a 
# best-fit line using the correstponding regression parameters.
